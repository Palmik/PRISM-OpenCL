#ifndef FOXGLYNN_OPENCL_CORE_CS
#define FOXGLYNN_OPENCL_CORE_CS
...
class FGCoreCS : public OpenCLKernel
{
  public:
    FGCoreCS(cl_device_id cl_device_, cl_context cl_context_, MatrixCS matrix, cl_real* fgw_ds)
      : OpenCLKernel(cl_device_, cl_context_, FGOpenCLSrc, "FGCoreCS") 
      , matrix_m(matrix)
    {
      cl_int err = 0;
